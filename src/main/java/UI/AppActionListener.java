    ...
    public void actionPerformed(ActionEvent e) {
        if (tabCloseButtons.contains(e.getSource())) {
            ...
            if (title.equals("Main Menu")) {
                // Main Menu
                app.addTab("Main Menu", new JLabel("Main Menu"));
                ...
                app.addTab("Riwayat Transaksi Member", new JLabel("Riwayat Transaksi Member"));
            } else if (title.equals("Jual Barang")) {
                app.addTab("Jual Barang", new JLabel("Jual Barang"));
            } else if (title.equals("Tambah Barang")) {
                app.addTab("Tambah Barang", new JLabel("Tambah Barang"));
            } else if (title.equals("Update Barang")) {
                app.addTab("Update Barang", new JLabel("Update Barang"));
